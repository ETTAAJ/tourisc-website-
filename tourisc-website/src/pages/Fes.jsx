...
const Fes = () => {
  ...
  const cityActivities = activities.filter(a => a.cityId === 'fes');
  ...
  const attractions = [
    { name: 'Fes el-Bali', description: 'The ancient medina, a UNESCO World Heritage site' },
    { name: 'Al-Qarawiyyin University', description: 'The world\'s oldest university' },
    { name: 'Chouara Tannery', description: 'Traditional leather dyeing pits' },
    { name: 'Bou Inania Madrasa', description: 'Stunning Islamic architecture' },
  ];
  ...
  return (
    <div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-dark">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white/80 leading-relaxed">
            {city.shortDescription} Fes stands as the cultural and spiritual heart of Morocco, 
            home to the world's largest car-free urban area. The ancient medina transports visitors 
            to another era, where traditional crafts flourish and Islamic architecture reaches its 
            pinnacle. Experience the authentic soul of Morocco in this timeless city.
          </p>
        </div>
      </section>
      ...
      <CTASection
        ...
        subtitle="Book your luxury experience today and discover the cultural capital"
